...
import es.age.apps.bridgit.core.Utilities.Sensors;
import es.age.apps.bridgit.core.Utilities.Utilities;
import es.age.apps.bridgit.core.communication.DeviceListActivity;
import es.age.apps.bridgit.core.remote.RemoteActivityCommunicationHandler;
import es.age.apps.bridgit.core.remote.RemoteActivityEvents;
import es.age.apps.bridgit.core.remote.R;
import es.age.apps.bridgit.core.remote.RCSignals;
import es.age.apps.bridgit.ui.joystick.DualJoystickView;
import es.age.apps.bridgit.ui.joystick.JoystickView;
...
public class RemoteActivity extends BaseActivity {
    ...
    private ProgressBar rcStickThrottleSlider, rcStickRollSlider, rcStickPitchSlider, rcStickYawSlider, rcStickAUX1Slider, rcStickAUX2Slider;
    private TextView txtV_th, txtV_p, txtV_r, txtV_y, txtV_a1, txtV_a2,txt_adress;
