...
public class JoystickView extends View {
	...
	// Last touch point in es.age.apps.bridgit.view coordinates
	...
	// Last reported position in es.age.apps.bridgit.view coordinates (allows different reporting
	// sensitivities)
	private float reportX, reportY;

	// Handle center in es.age.apps.bridgit.view coordinates
	private float handleX, handleY;

	// Center of the es.age.apps.bridgit.view in es.age.apps.bridgit.view coordinates
	private int cX, cY;

	// Size of the es.age.apps.bridgit.view in es.age.apps.bridgit.view coordinates
	...
	private boolean processMoveEvent(MotionEvent ev) {
		if (pointerId != INVALID_POINTER_ID) {
			...
			// Translate touch position to center of es.age.apps.bridgit.view
	...
	public void setCoordinates2(float touchX, float touchY) {
		if (!this.isPressed()) {
			handleX=touchX;
			handleY=touchY;
			reportOnMoved();
